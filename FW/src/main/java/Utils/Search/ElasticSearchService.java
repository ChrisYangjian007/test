...
//                    .put("client.transport.sniff", true).build();// 开启client.transport.sniff功能，探测集群所有节点
...
//            BulkRequestBuilder add = bulkRequest.add(client.prepareIndex(index, type, param1)
//                            .setSource(param2)
//            );
//        });
...
//        //排序
//        if (!StringExtend.Empty(constructor.getAsc()))
//            searchRequestBuilder.addSort(constructor.getAsc(), SortOrder.ASC);
//        if (!StringExtend.Empty(constructor.getDesc()))
