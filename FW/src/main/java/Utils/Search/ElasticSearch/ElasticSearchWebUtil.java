...
//import Model.Enum.ESOperateType;
//import Model.Enum.RequestMethodType;
...
// */
//public class ElasticSearchWebUtil implements ISearch {
////    private static Logger logger = Logger.getLogger(ElasticSearchWebUtil.class);
//
//    @Override
...
//        boolean bool = Boolean.parseBoolean(response_json.get("acknowledged").toString());
//        if(bool){
////            logger.info("mapping：" + indexName + "/"  + typeName + "删除成功");
//        }else{
////            logger.warn("mapping：" + indexName + "/"  + typeName + "删除失败");
//        }
//        return bool;
//    }
//
...
//        boolean bool = Boolean.parseBoolean(response_json.get("acknowledged").toString());
//        if(bool){
////            logger.info("创建mapping：" + indexName + "/"  + typeName + "成功");
//        }else{
////            logger.warn("创建mapping：" + indexName + "/"  + typeName +  "失败！");
//        }
//        return bool;
//    }
//
...
//            bool = false;
//        }
////        logger.info(bool ? "mapping：" + indexName + "/" + typeName + "存在" : "mapping：" + indexName + "/" + typeName + "不存在！");
//        return bool;
//    }
//
//    @Override
