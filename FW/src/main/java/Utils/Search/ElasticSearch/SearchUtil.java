...
//     * @return
//     */
//    public static Map<String, Object> parserParams(String params) throws Exception.ParamsParseException {
...
//            throw new Exception.ParamsParseException();
//        }
...
//                    throw new Exception.ParamsParseException("查询参数解析异常,包含空子句:&空&！");
//                }
...
//            throw new Exception.ParamsParseException("查询参数不正确，没有包含必要的查询字段(q字段)!");
//        }
...
//                    throw new Exception.ParamsParseException("已开启高亮查询，但是没有设置高亮查询字段！");
//                }
...
//                    throw new Exception.ParamsParseException("查询参数解析异常，排序参数设置语法错误,正确格式参考：字段+desc/asc！！");
//                }
//                String field = str.split("\\+")[0];
//                String sort = str.split("\\+")[1];
//                if (!("desc".equalsIgnoreCase(sort) || "asc".equalsIgnoreCase(sort))) {
//                    throw new Exception.ParamsParseException("查询参数解析异常，排序参数设置语法错误,请用asc/desc表示排序！");
//                }
...
//        }
//        catch (Exception.ParamsParseException e) {
//            e.printStackTrace();
//        }
...
//        return JSON.toJSONString(model, new SerializerFeature[]{
...
////        logger.info("扫描实体类：" + clazz + ",发现索引：" + indexName + ",发现类型：" + typeName + ",发现Field有效字段为：" + fieldsStr);
////        logger.info("扫描类" + clazz.getName() + "完成，生成的mapping如下：\n" + rootJson.toJSONString());
...
//            rootJson.put(typeName, typeJson);
//            fieldsStr = fieldsStr.substring(0, fieldsStr.length() - 1) + "]";
////            logger.info("扫描实体类：" + clazz + ",对应的索引：" + indexName + ",对应的类型：" + typeName + ",对应的ES有效字段为：" + fieldsStr);
//        }
////        logger.info("扫描包" + Constant.MODELS_PACKAGE + "下面的实体类完成，生成的mapping如下：\n" + rootJson.toJSONString());
//        return rootJson.toJSONString();
//    }
//
//    /* 读取setting配置文件 */
...
//            return null;
//        }
////        logger.info("读取settings文件：classpath/" + settingsFile + " ....");
