...
public class QuartzConfigration {
    ...
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(ScheduleTask task) {// ScheduleTask为需要执行的任务
        ...
        /*
         * importOrderToCrm为需要执行的方法
         * 通过这几个配置，告诉JobDetailFactoryBean我们需要执行定时执行ScheduleTask类中的importOrderToCrm方法
         */
        jobDetail.setTargetMethod("importOrderToCrm");
        return jobDetail;
    }
    ...
    public CronTriggerFactoryBean cronJobTrigger(MethodInvokingJobDetailFactoryBean jobDetail) {
        ...
        // 初始时的cron表达式
        tigger.setCronExpression("0 0 6,23 * * ? *");
