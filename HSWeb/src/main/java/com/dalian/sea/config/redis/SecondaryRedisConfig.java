...
public class SecondaryRedisConfig extends CachingConfigurerSupport {
    ...
    private JedisPoolConfig jedisPoolConfig() {
        ...
        MyRedisProperties props = redisProperties();
    ...
    public JedisPool jedisPool(){
        MyRedisProperties props = redisProperties();
        JedisPool jedisPool = new JedisPool(jedisPoolConfig(),props.getHost(),props.getPort(),props.getTimeout(),props.getPassword(),props.getDatabase());
        return jedisPool;
    }
