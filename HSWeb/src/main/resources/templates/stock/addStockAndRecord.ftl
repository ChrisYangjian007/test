                ...
                <table class="form">
                    <tr>
                        <td align="center" colspan="3" style="padding:5px 0">
                            <input id="seachNo" autocomplete="on" type="text" style="width:90%;height:25px"
                                   placeholder="输入单据/二维码编号或用手持抢扫一扫  （如：生产任务二维码/出货单二维码）"/>
                        </td>
                        <td>
                            <a onclick="seachNo()" class="btn-search">搜索</a>
                        </td>
                    </tr>
                    <tr>
                        <th class="formTitle">
                        ...
                        ${receiveNode}
                            ...
                            <input type="hidden" id="enterNo" value="${receiveNode}"/>
                        </td>
                        <th class="formTitle">
                            入库申请人：
                        </th>
...
<script>
    ...
    function initSearchEnterStock(num, batchNo) {
        Loading(true, "正在搜索", "#addStockAndRecordModal");
    ...
    function initSearchEnterStock2(num, batchNo) {
        Loading(true, "正在加载", "#addStockAndRecordModal");
        if (batchNo != "") {
