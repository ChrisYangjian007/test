<#--新增检测设备内容-->
<form id="addTestingEquipmentDetailForm" style="margin: 1px">
    <input type="hidden" name="testingEquipmentId" value="${pTestingEquipmentDetail.testingEquipmentId}">
    ...
    <table class="form">
        <tr>
            ...
            <td class="formValue">
                <input class="txt required" id="addTestingEquipmentDetailCname" type="text" name="testingEquipmentDetailCname"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="formValue">
                <textarea  class="txtArea" style="resize: none" id="testEqDetailRemark" name="remark" rows="5"></textarea>
            </td>
        </tr>
    </table>
    <br/>
